...
void QuickSorterTester::TestArrSeqSort() {
    ...
    "Success: Sequence<T>* Sort(Sequence<T>* sequence, int (*comparator)(T, T)); passed ArraySequence",
    "Error: Sequence<T>* Sort(Sequence<T>* sequence, int (*comparator)(T, T)); sorted incorrectly, passed ArraySequence"
    );
}
...
void QuickSorterTester::TestListSeqSort() {
    ...
    Informator(
            ...
            "Success: Sequence<T>* Sort(Sequence<T>* sequence, int (*comparator)(T, T)); passed ListSequence",
            "Error: Sequence<T>* Sort(Sequence<T>* sequence, int (*comparator)(T, T)); sorted incorrectly, passed ListSequence"
    );
}
